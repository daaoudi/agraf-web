    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="tab-2">
        <div class="row">
          ...
          <div class="col-lg-6 order-1 order-lg-2 text-center">
            <img src="storage/assets/img/features-2.jpg" alt="" class="img-fluid">
          </div>
        </div>
      </div><!-- End tab content item -->
      ...
      <div class="tab-pane" id="tab-3">
        <div class="row">
          ...
          <div class="col-lg-6 order-1 order-lg-2 text-center">
            <img src="storage/assets/img/features-3.jpg" alt="" class="img-fluid">
          </div>
        </div>
      </div><!-- End tab content item -->
      ...
      <div class="tab-pane" id="tab-4">
        <div class="row">
          ...
          <div class="col-lg-6 order-1 order-lg-2 text-center">
            <img src="storage/assets/img/features-4.jpg" alt="" class="img-fluid">
          </div>
        </div>
      </div><!-- End tab content item -->
  ...
  <div class="row gy-5">
    ...
    <div class="col-xl-4 col-md-6 fade-in" data-aos="fade-up" data-aos-delay="100">
      <div class="post-item position-relative h-100">
        ...
        <div class="post-img position-relative overflow-hidden">
          <img src="storage/assets/img/blog/blog-1.jpg" class="img-fluid" alt="">
    ...
    <div class="col-xl-4 col-md-6 fade-in" data-aos="fade-up" data-aos-delay="100">
      <div class="post-item position-relative h-100">
        ...
        <div class="post-img position-relative overflow-hidden">
          <img src="storage/assets/img/blog/blog-2.jpg" class="img-fluid" alt="">
