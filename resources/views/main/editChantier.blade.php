            ...
            <div class="col-md-6 " data-aos="fade">
                ...
                <form action="{{ route('chantiers.update', $chantiers->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row gy-3 ">
                        ...
                        <div class="col-md-12">
                            <input type="text" name="designation" value="{{ $chantiers->designation }}"
                                class="form-control" required>
                        </div>

                        <div class="col-md-12">
                            <input type="text" name="prix" value="{{ $chantiers->prix }}" class="form-control"
                                required>
                        </div>

                        <div class="col-md-12">
                            <input type="text" name="ville" value="{{ $chantiers->ville }}" class="form-control"
                                required>
                        </div>

                        <div class="col-md-12 ">
                            <label for="paiement">Votre Type de Paiement :</label>
                            <input type="text" class="form-control" value="{{ $chantiers->mode_paiement }}"
                                id="paiement" disabled required>
                        </div>
